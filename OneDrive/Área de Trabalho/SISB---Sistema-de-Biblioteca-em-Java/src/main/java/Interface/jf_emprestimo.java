 ...
 * @author bruno
 */
public class jf_emprestimo extends javax.swing.JInternalFrame {
        ...
        {   
            ...
            {   
                ...
                if (resultado.next()) {
                    ...
                    if(resultado.getInt("disponibilidade")==1){
                    ...
                    {
                       String s = "Livro indiponível";
                        JOptionPane.showMessageDialog(null, s);
                    }
                    
                }
                else {
                    String s = "ERRO na consulta";
                    JOptionPane.showMessageDialog(null, s);
                }
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvarActionPerformed
        ...
        String sql ="insert into emprestimo (cpf_user,exemplar_book,d_emprestimo,d_devolucao,saldo,devolucao)values('"+user.getCpf()+"','"+book.getExemplar()+"','"+ dataHoje+"','"+dataHoje.plusDays(7)+"',0,0)";
        ...
        { 
            ...
            if(this.conexao.conectar())
            {
                ...
                System.out.println("priemira sentenca");
                ...
                sentenca2.execute();
                System.out.println("segunda sentenca");
                this.conexao.getConnection().close(); //fecha a conexão com o banco
            }
            else {
                    String s = "ERRO";
