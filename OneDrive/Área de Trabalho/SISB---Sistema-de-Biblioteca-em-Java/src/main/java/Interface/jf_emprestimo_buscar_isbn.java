 ...
 * @author João Marcos
 */
public class jf_emprestimo_buscar_isbn extends javax.swing.JInternalFrame {

    /**
     * Creates new form JanelaEscola
     */
    private Conexao conexao;
    String emprestimo_isbn_pesquisa;
    
    public jf_emprestimo_buscar_isbn() {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Buscar emprestimos isbn");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        emprestimo_isbn_pesquisa=txt_isbn_pesquisa_livro.getText();
    ...
    public ArrayList<Livro> consultar() {
        ...
        String sql = "select * from livro inner join emprestimo on livro.exemplar = emprestimo.exemplar_book where livro.isbn like'%"+emprestimo_isbn_pesquisa+"%'";
