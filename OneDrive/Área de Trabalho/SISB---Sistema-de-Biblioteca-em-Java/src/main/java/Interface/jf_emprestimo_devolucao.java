 ...
 * @author guilh
 */
public class jf_emprestimo_devolucao extends javax.swing.JInternalFrame {
    ...
    public jf_emprestimo_devolucao() {
                ...
                if (resultado.next()) {
                    ...
                    if (resultado.getInt("disponibilidade") == 0) {
                        ...
                        if (resultado.next()) {
                            ...
                            // capturando a data de devolucao e convertendo em no formato date
                           ...
                           // INSERIR INSET COMO DEVOLVIDO NO LIVRO E NO EMPRESTIMO
                           
                            String sql_update = "update emprestimo set devolucao = 1 where exemplar_book ='" + exemplar_pesquisa + "' and devolucao = 0 and cpf_user ='" + cpf_pesquisa + "'";                                               
                           ...
                           sql_update = "update livro set disponibilidade = 1 where exemplar ='" + exemplar_pesquisa +"'";                                               
                           sentenca = this.conexao.getConnection().prepareStatement(sql_update);
                           
                           sentenca.execute(); //executa o comando no banco
                           sentenca.close(); //fecha a sentença
                            
                            // operando os valores da data
                            //dataDevolucao= LocalDate.now();
                            LocalDate dataDevulucao;
                            ...
                            if(dataEntrega.compareTo(dataDevolucao)>0)
                            {
                               int dias=(int) ChronoUnit.DAYS.between(dataDevolucao, dataEntrega);
                               sql_update = "update emprestimo set saldo = "+dias+" where exemplar_book ='" + exemplar_pesquisa + "'";
                               sentenca = this.conexao.getConnection().prepareStatement(sql_update);                         
                            ...
                            //dias = daysBetween(dataDevolucao, dataEntrega).getDays();
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvarActionPerformed
        ...
        try {
            ...
            if (this.conexao.conectar()) {
                //prepara a sentença com a consulta da string
                String sql_livro = "update livro set disponibilidade = 1 where exemplar ='" + exemplar_pesquisa + "'";
               
                PreparedStatement sentenca_livro = this.conexao.getConnection().prepareStatement(sql_livro);
                
                sentenca_livro.execute(); //executa o comando no banco
                sentenca_livro.close(); //fecha a sentença
                ...
                String sql_emprestimo = "update emprestimo set devolucao = 1 where exemplar_book ='" + exemplar_pesquisa + "'";

                PreparedStatement  sentenca_emprestimo = this.conexao.getConnection().prepareStatement(sql_emprestimo);
                  
                sentenca_emprestimo.execute(); //executa o comando no banco
                sentenca_emprestimo.close(); //fecha a sentença
            }
