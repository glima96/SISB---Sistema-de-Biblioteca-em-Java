 ...
 * @author João Marcos
 */
public class jf_livro_buscar_titulo extends javax.swing.JInternalFrame {

    /**
     * Creates new form JanelaEscola
     */
    private Conexao conexao;
    String titulo_pesquisa;
    
    public jf_livro_buscar_titulo() {
    ...
    private void initComponents() {
        ...
        lb_titulo_livro_cad.setText("Livros por Título");
        ...
        painelBuscaLayout.setVerticalGroup(
            ...
            .addGroup(painelBuscaLayout.createSequentialGroup()
                ...
                .addGroup(painelBuscaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(painelTabela, javax.swing.GroupLayout.DEFAULT_SIZE, 405, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        getAccessibleContext().setAccessibleName("Buscar por título");
    ...
    private void atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atualizarActionPerformed
        ...
        titulo_pesquisa=txt_isbn_pesquisa_livro.getText();
    ...
    public ArrayList<Livro> consultar() {
        ...
        String sql = "select * from livro where titulo like'%"+titulo_pesquisa+"%'";
