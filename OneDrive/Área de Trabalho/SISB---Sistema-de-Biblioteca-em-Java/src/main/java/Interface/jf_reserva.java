 ...
 * @author guilh
 */
public class jf_reserva extends javax.swing.JInternalFrame {
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salvarActionPerformed
        ...
        String sql ="insert into reserva (cpf_user,exemplar_book,d_prazo,finalizada)values('"+user.getCpf()+"','"+book.getExemplar()+"','"+dataHoje.plusDays(7)+"',0)";
