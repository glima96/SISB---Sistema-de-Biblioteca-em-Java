 ...
 * @author João Marcos
 */
public class jf_emprestimo_buscar_usuario extends javax.swing.JInternalFrame {

    /**
     * Creates new form JanelaEscola
     */
    private Conexao conexao;
    String emprestimo_pesquisa_user;
    
    public jf_emprestimo_buscar_usuario() {
    ...
    private void initComponents() {
        ...
        txt_emprestimo_pesquisa_user = new javax.swing.JTextField();

        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Buscar emprestimo usuario");
        ...
        lb_titulo_livro_cad.setText("Emprestimo ISBN");

        buscar.setBackground(new java.awt.Color(51, 102, 255));
        buscar.setFont(new java.awt.Font("Malgun Gothic", 1, 18)); // NOI18N
        ...
        txt_emprestimo_pesquisa_user.setFont(new java.awt.Font("Malgun Gothic", 0, 14)); // NOI18N
        txt_emprestimo_pesquisa_user.setPreferredSize(new java.awt.Dimension(140, 25));
        ...
        buscarISBNLayout.setHorizontalGroup(
            ...
            .addGroup(buscarISBNLayout.createSequentialGroup()
                ...
                .addGroup(buscarISBNLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txt_emprestimo_pesquisa_user, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(buscarISBNLayout.createSequentialGroup()
                ...
                .addGroup(buscarISBNLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(buscarISBNLayout.createSequentialGroup()
                        ...
                        .addGap(34, 34, 34)
                        .addComponent(txt_emprestimo_pesquisa_user, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        ...
        emprestimo_pesquisa_user=txt_emprestimo_pesquisa_user.getText();
    ...
    private javax.swing.JTextField txt_emprestimo_pesquisa_user;
    ...
    public ArrayList<Livro> consultar() {
        ...
        String sql = "select * from livro inner join emprestimo on livro.exemplar = emprestimo.exemplar_book inner join usuario on usuario.cpf=emprestimo.cpf_user where usuario.cpf = "+emprestimo_pesquisa_user+"";
