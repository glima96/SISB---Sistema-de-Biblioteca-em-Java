 ...
 * @author João Marcos
 */
public class jf_livro_buscar_editora extends javax.swing.JInternalFrame {

    /**
     * Creates new form JanelaEscola
     */
    private Conexao conexao;
    String editora_pesquisa;
    
    public jf_livro_buscar_editora() {
    ...
    private void initComponents() {
        ...
        lb_titulo_livro_cad.setText("Livros por Editora");
    ...
    private void atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atualizarActionPerformed
        ...
        editora_pesquisa=txt_isbn_pesquisa_livro.getText();
    ...
    public ArrayList<Livro> consultar() {
        ...
        String sql = "select * from livro where editora like'%"+editora_pesquisa+"%'";
