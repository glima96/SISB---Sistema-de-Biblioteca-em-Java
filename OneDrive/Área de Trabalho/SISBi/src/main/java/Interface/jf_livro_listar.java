 ...
 * @author João Marcos
 */
public class jf_livro_listar extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lb_titulo_livro_cad.setText("Lista de Livros");
        ...
        painelJanelaEscolaLayout.setVerticalGroup(
            ...
            .addGroup(painelJanelaEscolaLayout.createSequentialGroup()
                ...
                .addGroup(painelJanelaEscolaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(painelTabela, javax.swing.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void atualizaTabela(Conexao livro_dao)
    {
        ...
        try
        {
            ...
            listaLivro = consultar(); //consulta todos os registros da tabela 
    ...
    public ArrayList<Livro> consultar() {
        ...
        String sql = "SELECT ano, titulo, editora,edicao,autores,isbn,exemplar FROM livro ORDER BY EXEMPLAR";
